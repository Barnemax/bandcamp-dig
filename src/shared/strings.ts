const texts = {
  ...
  artistWatch: {
    ...
    onboardingPrompt: 'Scan your collection to find the artists/labels you buy from most. This downloads your collection and up to 50 artist pages from Bandcamp, so it only runs when you ask for it.',
    onboardingScanButton: 'Scan my collection',
    onboardingLoading: 'Loading your collection…',
    onboardingEmpty: 'No collection items found.',
    onboardingNoFan: 'Could not read your Bandcamp account details on this page.',
